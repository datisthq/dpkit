...
Defined in: core/build/field/types/Year.d.ts:5

Year field type

## Extends

- `BaseField`\<[`YearConstraints`](/reference/dpkit/yearconstraints/)\>
...
> `optional` **constraints**: [`YearConstraints`](/reference/dpkit/yearconstraints/)
...
Defined in: core/build/field/types/Year.d.ts:9
