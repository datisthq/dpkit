...
Defined in: core/build/field/types/Datetime.d.ts:5

Datetime field type

## Extends

- `BaseField`\<[`DatetimeConstraints`](/reference/dpkit/datetimeconstraints/)\>
...
> `optional` **constraints**: [`DatetimeConstraints`](/reference/dpkit/datetimeconstraints/)
...
Defined in: core/build/field/types/Datetime.d.ts:16
...
Defined in: core/build/field/types/Datetime.d.ts:9
