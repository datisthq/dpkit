...
Defined in: core/build/field/types/Yearmonth.d.ts:5

Year and month field type

## Extends

- `BaseField`\<[`YearmonthConstraints`](/reference/dpkit/yearmonthconstraints/)\>
...
> `optional` **constraints**: [`YearmonthConstraints`](/reference/dpkit/yearmonthconstraints/)
...
Defined in: core/build/field/types/Yearmonth.d.ts:9
