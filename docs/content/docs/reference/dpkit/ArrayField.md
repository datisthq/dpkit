...
Defined in: core/build/field/types/Array.d.ts:5

Array field type (serialized JSON array)

## Extends

- `BaseField`\<[`ArrayConstraints`](/reference/dpkit/arrayconstraints/)\>
...
> `optional` **constraints**: [`ArrayConstraints`](/reference/dpkit/arrayconstraints/)
...
Defined in: core/build/field/types/Array.d.ts:9
