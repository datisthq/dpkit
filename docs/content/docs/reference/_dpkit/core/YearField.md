...
Defined in: [core/field/types/Year.ts:6](https://github.com/datisthq/dpkit/blob/7a3ebb9422265a09d2e84e0952d10e0101139f80/core/field/types/Year.ts#L6)

Year field type

## Extends

- `BaseField`\<[`YearConstraints`](/reference/_dpkit/core/yearconstraints/)\>
...
> `optional` **constraints**: [`YearConstraints`](/reference/_dpkit/core/yearconstraints/)
...
Defined in: [core/field/types/Year.ts:10](https://github.com/datisthq/dpkit/blob/7a3ebb9422265a09d2e84e0952d10e0101139f80/core/field/types/Year.ts#L10)
