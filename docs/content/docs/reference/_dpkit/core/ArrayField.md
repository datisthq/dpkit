...
Defined in: [core/field/types/Array.ts:6](https://github.com/datisthq/dpkit/blob/7a3ebb9422265a09d2e84e0952d10e0101139f80/core/field/types/Array.ts#L6)

Array field type (serialized JSON array)

## Extends

- `BaseField`\<[`ArrayConstraints`](/reference/_dpkit/core/arrayconstraints/)\>
...
> `optional` **constraints**: [`ArrayConstraints`](/reference/_dpkit/core/arrayconstraints/)
...
Defined in: [core/field/types/Array.ts:10](https://github.com/datisthq/dpkit/blob/7a3ebb9422265a09d2e84e0952d10e0101139f80/core/field/types/Array.ts#L10)
