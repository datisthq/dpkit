...
export const Pages = {
  ...
  terminal: {
    ...
    title: {
      en: "Terminal Application",
      de: "Terminalanwendung",
      es: "Aplicación de Terminal",
      fr: "Application Terminal",
      it: "Applicazione Terminale",
      pt: "Aplicação de Terminal",
      ru: "Терминальное Приложение",
      uk: "Термінальне Застосування",
    },
    description: {
      en: "Terminal Application",
      de: "Terminalanwendung",
